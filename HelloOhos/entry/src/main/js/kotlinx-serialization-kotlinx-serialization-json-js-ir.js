import {
  ...
  polymorphicDefault2837p1r5vov8f as polymorphicDefault,
  ...
  ChunkedDecoder98alhrierfh5 as ChunkedDecoder,
...
} from './kotlinx-serialization-kotlinx-serialization-core-js-ir.js';
import {
  ...
  makeAssociatedObjectMapES53712dthbqmqjt as makeAssociatedObjectMapES5,
  ...
  SuspendFunction21m2v5qn6kxww9 as SuspendFunction2,
...
initMetadataForObject(JsonNull, 'JsonNull', VOID, JsonPrimitive, [JsonPrimitive, SerializerFactory], VOID, VOID, makeAssociatedObjectMapES5([SerializableWith, JsonNull_getInstance]));
...
initMetadataForInterface(JsonWriter, 'JsonWriter');
...
initMetadataForClass(Language, 'Language', VOID, VOID, [Annotation]);
initMetadataForClass(JsonToStringWriter, 'JsonToStringWriter', JsonToStringWriter, VOID, [JsonWriter]);
//endregion
function Default() {
...
function buildDeserializationNamesMap$putOrThrow(_this__u8e3s4, $this_buildDeserializationNamesMap, name, index) {
  ...
  if ((isInterface(_this__u8e3s4, KtMap) ? _this__u8e3s4 : THROW_CCE()).containsKey_aw81wo_k$(name)) {
    throw new JsonException("The suggested name '" + name + "' for property " + $this_buildDeserializationNamesMap.getElementName_u4sqmf_k$(index) + ' is already one of the names for property ' + ($this_buildDeserializationNamesMap.getElementName_u4sqmf_k$(getValue(_this__u8e3s4, name)) + ' in ' + toString($this_buildDeserializationNamesMap)));
  }
...
function readArray($this) {
  ...
  while ($this.lexer_1.canConsumeValue_oljqd7_k$()) {
    ...
    if (!(lastToken === 4)) {
      ...
      var position = tmp0.get_currentPosition_ic997d_k$();
      if (!condition) {
          ...
          if (tmp0_subject === 1) {
            ...
            if (tmp0_subject === 0) {
              ...
              if (tmp0_subject === 6) {
                ...
                suspendResult = readObject_0(this.this$0__1, this.$this$$receiver_1, this);
      ...
      switch (tmp) {
        ...
        case 4:
          if (this.lastToken2__1 === 6) {
            ...
            this.this1__1.lexer_1.fail$default_vqx2ls_k$('Unexpected trailing comma');
          }
...
function decodeSerializableValuePolymorphic(_this__u8e3s4, deserializer) {
  ...
  if (!(tmp0 instanceof JsonObject)) {
    throw JsonDecodingException_1(-1, 'Expected ' + toString(getKClass(JsonObject)) + ' as the serialized body of ' + descriptor.get_serialName_u2rqhk_k$() + ', but had ' + toString(getKClassFromExpression(tmp0)));
  }
  var jsonTree = tmp0;
  ...
  if ($this.lexer_1.canConsumeValue_oljqd7_k$()) {
    if (decodingKey) {
      if ($this.currentIndex_1 === -1) {
        ...
        var position_0 = tmp0_0.get_currentPosition_ic997d_k$();
        if (!condition_0) {
...
function coerceInputValue($this, descriptor, index) {
  ...
  var tmp2 = descriptor.getElementDescriptor_ncda77_k$(index);
  var tmp$ret$1;
  $l$block_2: {
    // Inline function 'kotlinx.serialization.json.internal.tryCoerceValue' call
    var tmp;
    if (!tmp2.get_isNullable_67sy7o_k$()) {
    ...
    if (equals(tmp2.get_kind_wop7ml_k$(), ENUM_getInstance())) {
      var tmp_0;
      if (tmp2.get_isNullable_67sy7o_k$()) {
...
function handleUnknown($this, key) {
  if ($this.configuration_1.get_ignoreUnknownKeys_kvp19_k$() || trySkip($this, $this.discriminatorHolder_1, key)) {
...
function primitive($this, _this__u8e3s4, primitive, block) {
  try {
...
protoOf(AbstractJsonTreeDecoder).beginStructure_yljocp_k$ = function (descriptor) {
  ...
  if (tmp_0) {
    ...
    if (!(currentObject_0 instanceof JsonArray)) {
      throw JsonDecodingException_1(-1, 'Expected ' + toString(getKClass(JsonArray)) + ' as the serialized body of ' + descriptor.get_serialName_u2rqhk_k$() + ', but had ' + toString(getKClassFromExpression(currentObject_0)));
    }
    ...
    if (equals(tmp0_subject, MAP_getInstance())) {
      ...
      if (tmp_3) {
        ...
        if (!(currentObject_0 instanceof JsonObject)) {
          throw JsonDecodingException_1(-1, 'Expected ' + toString(getKClass(JsonObject)) + ' as the serialized body of ' + descriptor.get_serialName_u2rqhk_k$() + ', but had ' + toString(getKClassFromExpression(currentObject_0)));
        }
...
protoOf(AbstractJsonTreeDecoder).decodeTaggedByte_oje7fc_k$ = function (tag) {
  var tmp2 = this.getPrimitiveValue_54kwg6_k$(tag);
  var tmp$ret$1;
  $l$block: {
    // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.primitive' call
    try {
...
protoOf(AbstractJsonTreeDecoder).decodeTaggedChar_ha7850_k$ = function (tag) {
  ...
  $l$block: {
    // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.primitive' call
    try {
      var tmp0_elvis_lhs = new Char(single(tmp2.get_content_h02jrk_k$()));
      var tmp;
      if (tmp0_elvis_lhs == null) {
...
protoOf(AbstractJsonTreeEncoder).beginStructure_yljocp_k$ = function (descriptor) {
  ...
  var encoder = tmp_0;
  if (!(this.polymorphicDiscriminator_1 == null)) {
    encoder.putElement_rnqfb1_k$(ensureNotNull(this.polymorphicDiscriminator_1), JsonPrimitive_0(descriptor.get_serialName_u2rqhk_k$()));
    this.polymorphicDiscriminator_1 = null;
  }
  return encoder;
};
...
protoOf(AbstractJsonLexer).unexpectedToken_ad91it_k$ = function (expected) {
  ...
  if (this.currentPosition_1 >= 0 && expected === _Char___init__impl__6a9atx(34) && this.consumeStringLenient_9oypvu_k$() === 'null') {
  ...
  this.fail_7t26ov_k$(charToTokenClass(expected));
};
protoOf(AbstractJsonLexer).fail_7t26ov_k$ = function (expectedToken) {
  ...
  var s = this.currentPosition_1 === charSequenceLength(this.get_source_jl0x7o_k$()) || this.currentPosition_1 <= 0 ? 'EOF' : toString_1(charSequenceGet(this.get_source_jl0x7o_k$(), this.currentPosition_1 - 1 | 0));
...
protoOf(AbstractJsonLexer).consumeNumericLiteral_rdea66_k$ = function () {
  ...
  $l$loop_0: while (hasChars) {
    ...
    accumulator = subtract(this_1, fromInt(digit));
...
protoOf(StringJsonLexer).consumeNextToken_uf1vsa_k$ = function () {
  ...
  $l$loop: while (!(this.get_currentPosition_ic997d_k$() === -1) && this.get_currentPosition_ic997d_k$() < source.length) {
...
protoOf(StringJsonLexer).tryConsumeComma_9n2ve4_k$ = function () {
  ...
  if (current === this.source_1.length || current === -1)
    return false;
  if (charCodeAt(this.source_1, current) === _Char___init__impl__6a9atx(44)) {
...
protoOf(StringJsonLexer).canConsumeValue_oljqd7_k$ = function () {
  ...
  $l$loop: while (current < this.source_1.length) {
    var c = charCodeAt(this.source_1, current);
    if (c === _Char___init__impl__6a9atx(32) || c === _Char___init__impl__6a9atx(10) || c === _Char___init__impl__6a9atx(13) || c === _Char___init__impl__6a9atx(9)) {
      current = current + 1 | 0;
      continue $l$loop;
    }
...
protoOf(StringJsonLexer).consumeKeyString_mfa3ws_k$ = function () {
  ...
  if (inductionVariable < closingQuote)
    do {
      var i = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
      if (charCodeAt(this.source_1, i) === _Char___init__impl__6a9atx(92)) {
  ...
  return substring(this.source_1, current, closingQuote);
};
