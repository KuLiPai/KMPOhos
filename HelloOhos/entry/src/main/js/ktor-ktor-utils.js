import {
  ...
  MutableIterator2wre2rj6iq57y as MutableIterator,
  ...
  HashMap_init_$Create$1veny2s4wofpu as HashMap_init_$Create$,
...
import { readBytes2b47ed7nra7rg as readBytes } from './ktor-ktor-io.js';
import { atomic$ref$130aurmcwdfdf1 as atomic$ref$1 } from './88b0986a7186d029-atomicfu-js-ir.js';
import {
...
function PlatformUtils() {
  ...
  this.IS_OHOS_1 = get_platform(this).equals(Platform_Ohos_getInstance());
...
protoOf(PlatformUtils).get_IS_OHOS_myv4vr_k$ = function () {
  return this.IS_OHOS_1;
};
...
var Platform_Ohos_instance;
function values() {
  return [Platform_Jvm_getInstance(), Platform_Native_getInstance(), Platform_Browser_getInstance(), Platform_Node_getInstance(), Platform_Ohos_getInstance()];
}
function valueOf(value) {
  switch (value) {
    ...
    case 'Ohos':
      return Platform_Ohos_getInstance();
    default:
      Platform_initEntries();
      THROW_IAE('No enum constant io.ktor.util.Platform.' + value);
      break;
  }
}
...
function Platform_initEntries() {
  ...
  Platform_Ohos_instance = new Platform('Ohos', 4);
}
...
function Platform_Ohos_getInstance() {
  Platform_initEntries();
  return Platform_Ohos_instance;
}
...
protoOf(StringValuesBuilderImpl).removeKeysWithNoEntries_wkzd9d_k$ = function () {
  ...
  // Inline function 'kotlin.collections.iterator' call
  var tmp0_iterator = destination.get_entries_p20ztl_k$().iterator_jk1svi_k$();
  while (tmp0_iterator.hasNext_bitz1p_k$()) {
    // Inline function 'kotlin.collections.component1' call
    var k = tmp0_iterator.next_20eer_k$().get_key_18j28a_k$();
...
protoOf(GMTDate).equals = function (other) {
  ...
  if (!(this.year_1 === tmp0_other_with_cast.year_1))
    return false;
  if (!equalsLong(this.timestamp_1, tmp0_other_with_cast.timestamp_1))
    return false;
  return true;
};
    ...
    try {
      ...
      switch (tmp) {
        ...
        case 3:
          ...
          suspendResult = (isSuspendFunction(executeInterceptor, 2) ? executeInterceptor : THROW_CCE())(this._this__u8e3s4__1, this._this__u8e3s4__1.subject_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(DebugPipelineContext).execute_ctedde_k$ = function (initial, $completion) {
  this.index_1 = 0;
...
protoOf(Pipeline).execute_qsx0hz_k$ = function (context, subject, $completion) {
  ...
  return createContext(this, context, subject, tmp$ret$0).execute_ctedde_k$(subject, $completion);
};
...
protoOf(Pipeline).phaseInterceptors_lqhc52_k$ = function (phase) {
...
protoOf(Pipeline).interceptorsForTests_xc6jl6_k$ = function () {
...
protoOf(SuspendFunctionGun).execute_ctedde_k$ = function (initial, $completion) {
  this.index_1 = 0;
  if (this.index_1 === this.blocks_1.get_size_woubt6_k$())
    return initial;
  this.subject_1 = initial;
...
function get__crypto() {
  ...
  var tmp0 = _crypto$delegate;
  var tmp = KProperty0;
  // Inline function 'kotlin.getValue' call
  getPropertyCallableRef('_crypto', 0, tmp, _get__crypto_$ref_ac3xpc(), null);
...
function _get__crypto_$ref_ac3xpc() {
  return function () {
    return get__crypto();
  };
}
...
function get_platform(_this__u8e3s4) {
  ...
  var hasWindowApi = (!(tmp_0 == null) ? typeof tmp_0 === 'boolean' : false) ? tmp_0 : THROW_CCE();
  var tmp_1;
  if (hasNodeApi) {
    tmp_1 = Platform_Node_getInstance();
  } else if (hasWindowApi) {
    tmp_1 = Platform_Browser_getInstance();
  } else {
    tmp_1 = Platform_Ohos_getInstance();
  }
  return tmp_1;
}
...
export {
  toByteArray as toByteArrayff6vypkyrde1,
  JsType_getInstance as JsType_getInstance12jtxtvadky3p,
  ...
  contains_0 as contains96i7cuon9uk6,
  contains as contains22jwcbcpbmgwc,
  forEach as forEachghjt92rkrpzo,
  get_0 as get3oezx9z3zutmm,
  StringValuesBuilderImpl as StringValuesBuilderImpl3ey9etj3bwnqf,
  StringValuesBuilder as StringValuesBuilder36dtrv5t4p001,
  ...
  caseInsensitiveMap as caseInsensitiveMap1xhpwzg797p51,
